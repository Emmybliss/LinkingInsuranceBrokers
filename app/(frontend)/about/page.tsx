...
const AboutPage = () => {
  return (
    <div className="flex min-h-screen flex-col justify-between overflow-hidden md:my-10 my-0 md:mx-0 mx-0 z-[40]">
      ...
      <div className="md:mx-36 z-[40]">
        ...
        <div className="mt-6 items-center justify-between gap-5 bg-gray-100 p-12  dark:bg-blue-950 md:grid md:grid-cols-3">
          <div className="mb-4 flex flex-col items-center gap-4 text-justify">
            ...
            <p className="text-lg">
              At Linking Insurance Brokers, our mission is to provide tailored
              and transparent insurance solutions that safeguard our clients'
              interests and financial well-being. We strive to build
              long-lasting relationships through personalized services, expert
              advice, and a commitment to excellence.
            </p>
          </div>
          <div className="mb-4 flex flex-col items-center gap-4 text-justify">
            <h2 className="flex items-center justify-center gap-2 text-2xl font-semibold">
            ...
            <p className="text-lg">
              ...
              trust, and unparalleled customer service, empowering individuals
              and businesses to navigate risks with confidence and security.
            </p>
          </div>
          <div className="mb-4 flex flex-col items-center gap-4 text-justify">
            <h2 className="flex items-center justify-center gap-2 text-2xl font-semibold">
            ...
            <ul className="flex flex-col text-left">
              <li className="flex items-center justify-start gap-2">
                ...
                To offer comprehensive and customized insurance packages that
          ...
          <div className="mb-4 flex flex-col items-center gap-4 text-justify">
            ...
            <ul className="flex flex-col text-left">
              ...
              <li className="flex items-center justify-start gap-2">
                <Check className="h-5 w-5 text-primary" />
                Strong relationships with leading insurance companies, allowing
                us to offer competitive policies.
              </li>
              <li className="flex items-center justify-start gap-2">
                <Check className="h-5 w-5 text-primary" />A focus on
                personalized service that places clients at the center of every
                decision.{" "}
              </li>
              <li className="flex items-center justify-start gap-2">
                <Check className="h-5 w-5 text-primary" />
          ...
          <div className="col-span-2 mb-4 flex flex-col gap-4 text-lg">
            ...
            <ul className="flex flex-col text-left">
              ...
              <li className="flex items-center justify-start gap-2">
                <Check className="h-5 w-5 text-primary" />
                Innovation: Continuously seeking ways to improve our services
                and provide value.
              </li>
              <li className="flex items-center justify-start gap-2">
                <Check className="h-5 w-5 text-primary" />
