...
import { ServicesDataType } from "@/lib/constants";

const ServiceList = ({ services }: { services: ServicesDataType[] }) => {
  return (
    <div className="md:mt-10 mt-5 md:mb-10 mb-5 z-[40]">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:grid z-[40]">
        {services.map((item) => (
